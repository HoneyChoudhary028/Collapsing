...
import com.example.rudra.collapsingtoolbardemo.Network.ApiClient;
import com.example.rudra.collapsingtoolbardemo.Network.ApiInterface;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void hitLoginApi() {
        ...
        LoginRequest.Param paramLogin=new LoginRequest.Param();
       ...
       apiInterface.loginApi(loginRequest).enqueue(new Callback<LoginResponse>() {
           @Override
           public void onResponse(Call<LoginResponse> call, Response<LoginResponse> response) {

               LoginResponse response1=response.body();
               String messsage=response1.getMessage();


               LoginResponse.ResultData resultData=response1.getResultData();
